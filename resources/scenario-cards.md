...
These scenario cards are designed for workshop exercises where teams practice responding to bus factor crises and succession planning challenges. Use them to stress-test your project's resilience and identify vulnerabilities before they become emergencies.
...
3. **Each group picks a card** (or you assign them based on the category you want to focus on)
...
## Governance, legal and finance scenarios
